...
echo -e "Grabbing file 'prodcons' from thoth.cs.pitt.edu ...\n"

scp jwm54@thoth.cs.pitt.edu:/afs/pitt.edu/home/j/w/jwm54/private/cs1550/project2//\{prodcons,linux-2.6.23.1/arch/i386/boot/bzImage,linux-2.6.23.1/System.map\} .
